...
## NADV74 - Advanced Development Systems
...
This is the codebase produced for the **NADV74 Advanced Development Systems** course
...
2. Clone `ONLY THE LATEST COMMIT` of this repository into your local machine using the terminal (mac) or
   ...
   ```sh
   git clone https://github.com/iammelvink/NADV74.git --depth=1
   ```
